@php
    $promoImage = $promoSetting->image ?? 'img/home_2.jpg';
    ...
    <div class="popup_content newsletter_c">
        ...
        <div class="row g-0">
            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center">
                <figure><img src="{{ $promoImageSrc }}" alt="{{ method_exists($promoSetting, 't') ? $promoSetting->t('title') : ($promoSetting->title ?? 'Promo') }}"></figure>
            </div>
            <div class="col-md-7">
                <div class="content">
                    <div class="wrapper">
                        ...
                        @endif
                        <h3>{{ method_exists($promoSetting, 't') ? $promoSetting->t('title') : ($promoSetting->title ?? 'Promo') }}</h3>
