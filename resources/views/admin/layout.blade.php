    ...
    $adminNavGroups = [
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'children' => [
                        ['label' => 'Header accueil', 'route' => route('admin.hero.index'), 'active' => request()->routeIs('admin.hero.*'), 'icon' => 'bi-play-circle'],
                        ['label' => 'À propos', 'route' => route('admin.about.index'), 'active' => request()->routeIs('admin.about.*'), 'icon' => 'bi-info-circle'],
                        ['label' => 'Equipements', 'route' => route('admin.installations.index'), 'active' => request()->routeIs('admin.installations.*'), 'icon' => 'icon-hotel-reception'],
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Contact', 'route' => route('admin.settings.index'), 'active' => request()->routeIs('admin.contact.*') || request()->routeIs('admin.settings.*'), 'icon' => 'bi-envelope'],
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Paramètres', 'route' => route('admin.settings.index') . '#site-settings', 'active' => request()->routeIs('admin.settings.*'), 'icon' => 'bi-gear'],
