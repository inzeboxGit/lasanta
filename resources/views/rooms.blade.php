...
<main>
    ...
    @php
        ...
        $labels = [
            ...
            'nl' => [
                'hero_subtitle' => 'Hotelbeleving',
                'hero_title' => 'Onze kamers & suites',
                'from' => 'Vanaf',
                'per_night' => 'EUR/nacht',
                'price_on_request' => 'Prijs op aanvraag',
                'room_desc_fallback' => 'Ontdek deze kamer en geniet van een comfortabel verblijf in Residence Bella Vista.',
                'amenity_1' => 'Premium comfort',
                'amenity_2' => 'Wifi',
                'amenity_3' => 'TV',
                'book' => 'Boeken',
                'read_more' => 'Lees meer',
                'empty' => 'Momenteel geen gepubliceerde kamers.',
            ],
        ];
    ...
    <div class="hero medium-height jarallax" data-jarallax data-speed="0.2">
        ...
        <div class="wrapper opacity-mask d-flex align-items-center justify-content-center text-center animate_hero" data-opacity-mask="rgba(0, 0, 0, 0.5)">
            <div class="container">
                <small class="slide-animated one">{{ method_exists($appartmentPageSetting, 't') ? $appartmentPageSetting->t('subtitle') : ($appartmentPageSetting->subtitle ?? $ui['hero_subtitle']) }}</small>
                <h1 class="slide-animated two">{{ method_exists($appartmentPageSetting, 't') ? $appartmentPageSetting->t('title') : ($appartmentPageSetting->title ?? $ui['hero_title']) }}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="row_list_version_1">
                <div class="pinned-image rounded_container pinned-image--medium">
                    <div class="pinned-image__container">
                        <img src="{{ $imageSrc }}" alt="{{ method_exists($room, 't') ? $room->t('title') : $room->title }}">
                    </div>
                </div>
                <!-- /pinned-image -->
                <div class="{{ $rowClass }}">
